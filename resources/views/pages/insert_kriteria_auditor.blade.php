        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Kriteria Audit Baru</h1>
                    ...
                    <form action="{{ route('kriteria.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="nama_kriteria" id="nama_kriteria" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" value="{{ old('nama_kriteria') }}" required placeholder="Contoh: Kepatuhan Prosedur Keamanan">
                            </div>

                            <div>
                                <label for="deskripsi_kriteria" class="block text-sm font-medium text-gray-700">Deskripsi</label>
                                <textarea name="deskripsi_kriteria" id="deskripsi_kriteria" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" required placeholder="Jelaskan secara singkat apa yang dinilai dalam kriteria ini.">{{ old('deskripsi_kriteria') }}</textarea>
                            </div>
                        </div>
