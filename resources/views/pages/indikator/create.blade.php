                ...
                <div class="p-6 text-gray-900
                    ...
                    <form action="{{ route('indikator.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="teks_indikator" name="teks_indikator" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 required>{{ old('teks_indikator') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="bobot" name="bobot" value="{{ old('bobot') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 required step="0.01">
                             @error('bobot')
                                <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                            @enderror
                        </div>
